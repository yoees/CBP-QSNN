...
class BasicBlock(nn.Module):
    def __init__(self, in_channels, mid_channels, mode=None):
        ...
        self.conv = nn.Sequential(
            ...
            layer.SeqToANNContainer(
                QConv2d(mid_channels, in_channels, kernel_size=3, padding=1, stride=1, bias=False, mode=mode),
...
def PlainNet(mode):
    ...
    num_classes = 11
    return ResNetN(layer_list, num_classes, mode)

#def SpikingResNet(*args, **kwargs, mode):
def SpikingResNet(mode):
    layer_list = [
